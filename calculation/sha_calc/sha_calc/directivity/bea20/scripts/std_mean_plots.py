...
for fault_name in faults:
    ...
    baseline_array = (
        pd.read_csv(
            f"/home/joel/local/directivity/new_baseline/{fault_name}_20000.csv",
            index_col=0,
        )
        .to_numpy()
        .reshape((10000, 1))
    ...
    for mode in modes:
        ...
        if mode == "mean bias":
            fig.savefig(
                f"/home/joel/local/directivity/latin/mc/plots/{fault_name}_mean_bias.png"
            )
        else:
            fig.savefig(
                f"/home/joel/local/directivity/latin/mc/plots/{fault_name}_{mode}.png"
            )
        plt.close()
