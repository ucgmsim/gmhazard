...
for fault_name in faults:
    ...
    for x, site in enumerate(sites):
        ...
        for i, nhyp in enumerate(nhyps):
            total = np.load(f"/home/joel/local/directivity/latin/mc/data/{fault_name}_{nhyp}_total_fd.npy").reshape((100, 100, 100, 1))
        ...
        plt.savefig(f"/home/joel/local/directivity/latin/mc/plots/sites/convergance_{fault_name}_site_{x}.png")