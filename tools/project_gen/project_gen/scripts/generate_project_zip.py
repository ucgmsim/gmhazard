...
from project_api.api.project import create_project_zip
...
def main(project_dir: Path, output_dir: Path, n_procs: int = 1):
    ...
    zip_ffp = create_project_zip(
        project_dir.parent.parent, project_dir.name, version_str, output_dir, n_procs=n_procs
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_procs", type=int, help="Number of processes to use", default=1)
